...
class Question2:
    def __init__(self, dimes_and_quarters=None):
        ...
        for key in ['dimes', 'quarters']:
            if dimes_and_quarters and key in dimes_and_quarters:
                self.dimes_and_quarters[key] = dimes_and_quarters[key]
            else:
                self.dimes_and_quarters[key] = 0
    ...
    def get_coins(self):
        ...
        """
        return self.dimes_and_quarters
    ...
    def get_balance_cents(self):
        ...
        """
        return self.dimes_and_quarters['dimes'] * 10 + self.dimes_and_quarters['quarters'] * 25
...
class Question3:
    ...
    def add_coins(self, dimes_and_quarters):
        ...
        """
        self.dimes_and_quarters['dimes'] += dimes_and_quarters[0]
        self.dimes_and_quarters['quarters'] += dimes_and_quarters[1]
